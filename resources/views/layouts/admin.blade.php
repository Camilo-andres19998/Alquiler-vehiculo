...
<html>
  <head>
    ...
    <title>Vehiculos | www.vehiculos.com</title>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.vehiculo.com - Desarrollando Software
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/alquiler/ingreso"><i class="fa fa-circle-o"></i> Ingresos</a></li>
                <li><a href="/alquiler/mecanico"><i class="fa fa-circle-o"></i> Proveedores</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Vehiculos</h3>
