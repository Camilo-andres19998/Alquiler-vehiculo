...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Editar Marca: {{$vehiculo->marca}}</h3>
			@if (count($errors)>0)
            ...
            <div class="form-group">
            	...
            	<input type="text" name="descripcion" require value="{{$vehiculo->descripcion}}" class="form-control" placeholder="Descripción...">
            </div>
			</div>
			...
			<div class="form-group">
            	...
            	<input type="text" name="venta" value="{{$vehiculo->venta}}" class="form-control" placeholder="Descripción...">
            </div>
			</div>
